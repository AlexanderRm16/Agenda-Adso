      ...
      <header className="border-b border-slate-800 bg-slate-950/60 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Boton de cierre de sesion: siempre visible en el dashboard */}
            <button
              type="button"
              onClick={logout}
              className="text-xs md:text-sm px-4 py-2 rounded-xl border border-slate-700 text-slate-200 hover:bg-slate-800 hover:text-white transition-colors"
            >
              Cerrar sesión
            </button>
          </div>
          ...
          <aside className="space-y-4 md:space-y-5">
            ...
            <div className="rounded-2xl bg-slate-900 border border-slate-700 p-4 text-slate-100 shadow-sm">
              ...
              <p className="text-xs text-slate-400 mt-3">
                “Transformar lógica estructurada en soluciones tecnológicas con impacto. Mi meta es diseñar, construir y desplegar aplicaciones web rápidas, escalables y orientadas al usuario”
              </p>
            </div>
          </aside>
        </div>
